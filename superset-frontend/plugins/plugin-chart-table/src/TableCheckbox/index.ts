 ...
 */
 ...
 import { TableCheckboxFormData, TableCheckboxProps } from './types';
 ...
 export default class TableCheckboxPlugin extends ChartPlugin<
 TableCheckboxFormData,
 TableCheckboxProps
 > {
   constructor() {
     super({
       loadChart: () => import('./TableCheckbox'),
       metadata,
       transformProps,
       controlPanel,
       buildQuery,

...
import { TableCheckboxFormData } from './types';
 ...
 */
export function getQueryMode(formData: TableCheckboxFormData) {
...
const buildQuery: BuildQuery<TableCheckboxFormData> = (
  formData: TableCheckboxFormData,
  options,
) => {
...
export const cachedBuildQuery = (): BuildQuery<TableCheckboxFormData> => {
